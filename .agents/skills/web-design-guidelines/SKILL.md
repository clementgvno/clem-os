...
description: Web Interface Guidelines from Vercel — MUST/SHOULD/NEVER rules for keyboard and focus behaviour, hit targets, forms, animation, layout, content and accessibility, performance, dark mode and hydration. Use when building or reviewing any UI component, page or interaction, and when asked to audit accessibility, focus states, touch targets, motion or perceived performance. Pairs with frontend-design, which covers aesthetic direction rather than interface correctness.
license: MIT
---
